...
`define RVOP_SLLI         `RVOP_I
`define RVOP_JARL         `RVOP_JUMP
`define RVOP_STORE_AUTISM `RVOP_RETARDED
`define RVOP_SHOW_AUTISM  `RVOP_RETARDED
...
`define RVF3_STORE_AUTISM 3'b000
`define RVF3_SHOW_AUTISM  3'b001
`define RVF3_ANY          3'b???
