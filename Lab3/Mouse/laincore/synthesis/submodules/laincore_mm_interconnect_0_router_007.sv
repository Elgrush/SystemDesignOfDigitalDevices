...
module laincore_mm_interconnect_0_router_007_default_decode
  #(
...
module laincore_mm_interconnect_0_router_007
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PKT_TRANS_WRITE = 1185;
    localparam PKT_TRANS_READ  = 1186;
    ...
    laincore_mm_interconnect_0_router_007_default_decode the_default_decode(
