...
module laincore_mm_interconnect_1_router_default_decode
  #(
...
module laincore_mm_interconnect_1_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    laincore_mm_interconnect_1_router_default_decode the_default_decode(
